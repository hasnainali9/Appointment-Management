...
<script type="text/javascript" src="../assets/js/EditPermissions.js"></script>
</head>
<body>
...
<div class="jumbotron">
  <a href="./settings.php" class="bg-primary circle"> <i class="fa fa-arrow-left" style="margin-left: 20%;"></i> </a>
   <div class="heading" style="margin-left: 15%;margin-top: 0%"><h1><i class="fa fa-cog"></i> Remove Shared Project Permissions</h1><br><br></div>
                                  

                                  <div class="row text-center">
                                      <div class="col-md-12">
                                            <label>Select the Project : </label>
                                          <select  id="SelectProjectPermissionsOptions" style="border-radius: 15px;width: 203px; text-align-last:center;"></select>
                                      </div>
                                  </div>
