...
<div class="sidebar-container">
  ...
  <ul class="sidebar-navigation">
    ...
    <li id="active"><a href="./index.php"><i class="fa fa-home" aria-hidden="true"></i>Dashboard</a></li>
...
<!---------------------------------------------------Main Content------------------------------>
    <div class="heading" style="margin-left: 25%;margin-top: 0%"><h1><i class="fa fa-home"></i> Upcomming Meetings</h1><br><br></div>
...
<div class="heading" style="margin-left: 25%;margin-top: 0%"><h1><i class="fa fa-home"></i> Check Meetings Details</h1><br><br></div>

    <div class="row text-center">
          <div class="col-md-12 text-center">
                                <label>Select the Project : </label>
                                <select id="SearchSheduleAppointments" name="SearchSheduleAppointments" style="border-radius: 15px;width: 203px; text-align-last:center;"></select></div>
      </div>




<table class="table SearchUpcommingAppointments">
<thead class='thead-dark'><tr><th class='text-center'>Empty</th></tr></thead>
</table>
